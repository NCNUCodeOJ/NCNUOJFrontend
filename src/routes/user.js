...
const routes = [
  ...
  { path: '/lesson/ExamList', exact: true, name: '測驗清單', component: ExamList },
  { path: '/lesson/ExamInfo', exact: true, name: '測驗內容', component: ExamInfo },
  { path: '/lesson/HomeWorkInfo', exact: true, name: '作業內容', component: HomeworkInfo },
  { path: '/lesson/HomeworkList', exact: true, name: '作業清單', component: HomeWorkList },
